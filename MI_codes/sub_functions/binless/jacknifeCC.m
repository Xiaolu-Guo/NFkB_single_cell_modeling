...
% X. Actual information calculation is performed by "getCC_wo_resampling".
%
%
...
[info1, Q] = getCC_wo_resampling(X,K,0); %full set of data 
...
for k=1:Nss 
    ...
    for ds=1:D(k)    
        ...
        info(ds) = getCC_wo_resampling(sX,K,0);   
    end
    Ik{k}=info;
end
I=[info1; Ik];
