...
function [info, sc_info, nfkb, all_dims, names_1D, sc_dims, names_sc_1D] = run_script_fxn_traj_XG_2024(local_flag, data_file,time_dim)
...
if ~local_flag
    ...
    [info, sc_info] = inforun_singaling_codons_XG(all_dims, sc_dims, names_sc_1D,time_dim);
