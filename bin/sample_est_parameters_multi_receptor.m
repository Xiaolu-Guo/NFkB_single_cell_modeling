function [para_val,estimates_params_sample] = sample_est_parameters_multi_receptor(proj_num,Num_sample,data_parent_path,var_fold)
...
for i_ligand =1:length(proj_num)
    [para_sample_ligand_large{i_ligand},~] = sample_est_parameters_2(proj_num(i_ligand),max(Num_sample)*1000,data_parent_path,var_fold);
    [para_sample_ligand{i_ligand},estimates_ligand{i_ligand}] = sample_est_parameters_2(proj_num(i_ligand),Num_sample(i_ligand),data_parent_path,var_fold);
