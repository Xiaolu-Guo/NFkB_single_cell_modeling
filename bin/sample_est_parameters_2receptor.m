function [para_val,estimates_params_sample] = sample_est_parameters_2receptor(proj_num,Num_sample,data_parent_path,var_fold)
...
[para_sample_ligand1_large,~] = sample_est_parameters(proj_num(1),Num_smaple_2*1000,data_parent_path,var_fold);
[para_sample_ligand1,estimates_ligand1] = sample_est_parameters(proj_num(1),Num_sample_1,data_parent_path,var_fold);

[para_sample_ligand2_large,~] = sample_est_parameters(proj_num(2),Num_sample_1*1000,data_parent_path,var_fold);
[para_sample_ligand2,estimates_ligand2] = sample_est_parameters(proj_num(2),Num_smaple_2,data_parent_path,var_fold);
