function [params, species] = nfkbInitialize_TNF_TRAF2_paraset2()
...
params(59,1) = 5; % Activation of TRAF2/RIP1 with receptor trimer
% to be tuned
params(60,1) =0.01; % Deactivation of TRAF2/RIP1 with receptor trimer
params(61,1) = 0; % degradation of TRAF2
% to be tuned
params(62,1) = 10; % Activation of TTR (TRAF2-TRADD-RIP)
% to be tuned
params(63,1) = 50; % Inactivation of complexed TTR
params(64,1) = 0; % degradation of C1
% to be tuned
params(65,1) = 10; % Activation of TAK1 by C1
