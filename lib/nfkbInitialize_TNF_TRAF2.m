function [params, species] = nfkbInitialize_TNF_TRAF2()
...
% to be tuned
params(60,1) = 1; % Deactivation of TRAF2/RIP1 with receptor trimer
params(61,1) = 0; % degradation of TRAF2
% to be tuned
params(62,1) = 5; % Activation of TTR (TRAF2-TRADD-RIP)
% to be tuned
params(63,1) = 50; % Inactivation of complexed TTR
params(64,1) = 0; % degradation of C1
% to be tuned
params(65,1) = 1500; % Activation of TAK1 by C1
params(65,2) = 1;
