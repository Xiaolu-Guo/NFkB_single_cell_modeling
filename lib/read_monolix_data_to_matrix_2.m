function data = read_monolix_data_to_matrix_2(data_proj_num_vec,data_parent_path,cell_num_data)
% input
...
for i_proj = 1:length(data_proj_num_vec)
    ...
    [proj_path,proj_name] = subfunc_get_proj_path_2(proj_num,data_parent_path);
