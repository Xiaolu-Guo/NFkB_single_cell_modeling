...
function delta = nfkbOde_TNF_TRAF2(t,x,ode_options,v)
% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
rxn_59 = p(59,1) * TNFR_TNF * TRAF2_off;
rxn_60 = p(60,1) * TRAF2;
rxn_61 = p(61,1) * TRAF2;
rxn_62 = p(62,1) * TRAF2 * C1_off;
rxn_63 = p(63,1) * C1;
rxn_64 = p(64,1) * C1;
...
delta(30) = - rxn_57 - rxn_58  + rxn_56 ;% - rxn_59 + rxn_60
delta(31) = 0;% - rxn_59 + rxn_60;
delta(32) = - rxn_62 + rxn_63 ;
...
delta(53) = - rxn_59 + rxn_60;
delta(54) = rxn_59 - rxn_60 - rxn_61;
