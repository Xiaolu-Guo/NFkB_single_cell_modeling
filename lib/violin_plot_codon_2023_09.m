function [] = violin_plot_codon_2023_09(collect_feature_vects,figure_option)
...
for i=1:length(codewords)
    ...
    for jj=1:length(ligand_all)
        ...
        if plot_ornot
            ...
            vects_index_0 = id_begin:id_end;
            vects_index = vects_index_0;
            vects_len = length(vects_index_0);
...
%             vects_index(2:2:vects_len) = vects_index_0(1:2:vects_len);
            ...
            violin_202309(data_type,vects(vects_index), plot_pos, 'Axes', ax, 'YLim', ylimits);
