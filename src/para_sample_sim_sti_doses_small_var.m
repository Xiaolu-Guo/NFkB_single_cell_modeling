...
% clear all
function [] = para_sample_sim_sti_doses_small_var(data_save_file_path,Num_sample,ligand_str,var_fold)
...
for i_proj_num_vec = 1:length(proj_num_vec)
    ...
    switch length(proj_num_vec{i_proj_num_vec})
        case 1
            [para_val,est]  = sample_est_parameters(proj_num_vec{i_proj_num_vec},Num_sample,'../SAEM_proj_2022/',var_fold);
        ...
        case 2
            ...
            [para_sample_2ligand,estimates_2ligand] = sample_est_parameters_2receptor(proj_num_vec{i_proj_num_vec},Num_sample*2,'../SAEM_proj_2022/',var_fold);
