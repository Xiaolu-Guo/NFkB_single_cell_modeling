...
file_list = {'Sim17_reduce_core_heterogeneity_codon_metric1.mat'
    ...
    'Sim18_wt_IkBo_codon_metric4.mat'
...
data_labels = {'NFkB_var_red1',...
    ...
    'NFkB_var_red9',...
    'NFkB_var_red10',...
    'wt1','IkBo2','IkBo3','IkBo4','rcpt_red','TAKac_red','TAKac_NFkB_red1','TAKac_NFkB_red2',...
    'TAK_noise',...
    'NFkB_noise',...
    'no_noise'};
...
for i_data = 1:length(data_labels)
    ...
    if min_max_rescale
        save(strcat('mutual_info_format_alldata_sc_',data_name{i_data},'_min_max_rescale_0219.mat'),'nfkb')
        
    else
        save(strcat('mutual_info_format_alldata_sc_',data_name{i_data},'_0219.mat'),'nfkb')
    end
