function [] = draw_traj_codon(data_save_file_path,fig_save_path,module_info)
...
if 1
    for i_metric =1:length(features_metric_fields)
        ...
        saveas(gcf,strcat(fig_save_path,'Codon',vers,'_',module_info.ligand{1},'_',module_info.para_type{1},features_metric_fields{i_metric}),'epsc')
