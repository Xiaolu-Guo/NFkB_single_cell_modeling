...
% clear all
function [] = para_sample_fitting_weighted_match_sim_2024(data_save_file_path,input_paras,cal_codon,save_metric_name,fitting_dose)
...
for i_proj_num_vec = 1:length(proj_num_vec)
    ...
    save_filename = strcat('202401_para_sampled_fitting_NFkBinit_',replace(num2str(var_fold),'.','p'),'varfoldchange');
