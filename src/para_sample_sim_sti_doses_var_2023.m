...
% clear all
function [] = para_sample_sim_sti_doses_var_2023(data_save_file_path,monolix_data_save_file_path,input_paras,cal_codon,save_metric_name)
...
for i_proj_num_vec = 1:length(proj_num_vec)
    ...
    switch length(proj_num_vec{i_proj_num_vec})
        case 1
            [para_val,est]  = sample_est_parameters_2023(proj_num_vec{i_proj_num_vec},Num_sample,monolix_data_save_file_path,var_fold);
        ...
        otherwise
            ...
            [para_sample_multi_ligand,estimates_2ligand] = sample_fitted_parameters_multi_receptor_2023_05(proj_num_vec{i_proj_num_vec},Num_sample,monolix_data_save_file_path,var_fold);
    ...
    save_filename = strcat('202301_para_sampled_NFkBinit_',replace(num2str(var_fold),'.','p'),'varfoldchange');
