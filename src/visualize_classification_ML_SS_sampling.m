...
i_data_set = 1;
data_name{i_data_set} = 'SS_Sampling_0x_r1';
data_set_all = data_name;
method_all = {'XGB'};
confusion_mat_all{1} = readmatrix(strcat('./python/XGBClassification_',data_name{i_data_set},'.csv'));
% 
% [325,2,0,2,4;1,253,51,27,17;3,45,207,23,32;9,16,16,288,3;11,12,33,11,259];% XGB
% 
% confusion_mat_all{2} = [3.15E+02	0.00E+00	4.00E+00	0.00E+00	1.40E+01
% 3.00E+00	2.35E+02	6.60E+01	2.50E+01	2.00E+01
% 3.00E+00	5.40E+01	1.98E+02	2.70E+01	2.80E+01
% 0.00E+00	1.30E+01	1.80E+01	2.98E+02	3.00E+00
% 1.60E+01	2.50E+01	2.80E+01	9.00E+00	2.48E+02]; % XGB cross validation
% 
