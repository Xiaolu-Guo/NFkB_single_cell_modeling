function sim_data_tbl = genotype_sim_save_2023_CpGpolyIC_compete(sim_info,data_info,gene_info) %,codon_info
...
for i_para_vec = 1:length(gene_info.parameter_name_vec)
    ...
    for i_gene_type = 1:length(gene_info.gene_type)
        ...
        sim_data_tbl_tmpt = NFkB_signaling_para_conc_sim_2023_CpGpolyIC_compete(sim_info,data_info);
