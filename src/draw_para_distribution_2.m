function [] = draw_para_distribution_2(data_save_file_path,fig_save_path)
...
for i_sti = 1:length(sti_vec)
    ...
    [para_sample,para_name,estimates] = read_draw_individual_parameters_2(proj_num,data_save_file_path);
