...
if 1 %draw 5 ligand single ligand stim
    ...
    % Sim16_IkBao_5_signle_ligand_codon_metric_0x _r1
    ...
    if 1
        ...
        if single_cell_specificity_plot
            ...
            histogram(clusterResults,0.5:1:5.5)
            ...
            xlabel('cluster nums')
            ylabel('counts')
            % saveas(gcf,strcat(fig_save_path,'Single_cell_Cluster_hist',vers_savefig),'epsc')
            close
