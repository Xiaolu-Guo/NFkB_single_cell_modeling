function [] = draw_para_distri_hist_2023(data_save_file_path,fig_save_path)
...
for i_sti = 1:length(sti_vec)
    ...
    [para_sample{i_sti},para_name{i_sti},estimates{i_sti}] = read_draw_individual_parameters_2023(proj_num,data_save_file_path);
