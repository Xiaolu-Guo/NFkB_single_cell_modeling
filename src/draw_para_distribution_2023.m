function [] = draw_para_distribution_2023(data_save_file_path,fig_save_path)
...
for i_sti = 1:length(sti_vec)
    ...
    [para_sample,para_name,estimates] = read_draw_individual_parameters_2023(proj_num,data_save_file_path);
    ...
    data_save_file_path = '../SAEM_proj_2023/';
