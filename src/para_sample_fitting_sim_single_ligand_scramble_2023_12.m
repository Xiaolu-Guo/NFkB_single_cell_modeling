...
% clear all
function [] = para_sample_fitting_sim_single_ligand_scramble_2023_12(data_save_file_path,input_paras,cal_codon,save_metric_name,fitting_dose)
...
for i_proj_num_vec = 1:length(proj_num_vec)
    ...
    switch length(proj_num_vec{i_proj_num_vec})
        ...
        otherwise
            ...
            [para_sample_multi_ligand,estimates_2ligand] = sample_scramble_fitting_multi_receptor_2023_11(proj_num_vec{i_proj_num_vec},Num_sample(i_proj_num_vec),data_fitting,data_fitting_all,sim_info,'alldose');
