...
% clear all
function [sim_data_tbl,data,metrics,collect_feature_vects] = para_sample_sim_single_2_ligand_2023_12(data_save_file_path,input_paras,cal_codon,fitting_dose)
